...
class Node {
 ...
 public:
  enum class Type { Empty, Service, Element, Tree };
 ...
 private:
  ...
  std::variant<empty_t, service_t, text_t, container_t> m_body;
};
...
class Document {
 public:
  Document() = default;  //Для возможности создания пустого объекта и
                         //дальнейшего вызова оператора присваивания
 ...
 private:
  ...
  Document(node_holder declaration, node_holder root, allocator_holder alloc);
