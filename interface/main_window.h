#pragma once
#include "cm_gui_dll_interface.hpp"
...
namespace Ui {
class CompanyManagerGUI;
}

class CM_GUI_API CompanyManagerUI : public QMainWindow {
  Q_OBJECT
 public:
 ...
 public:
  ...
  CompanyManagerUI(const CompanyManagerUI&) = delete;
  CompanyManagerUI(CompanyManagerUI&&) noexcept = default;
  CompanyManagerUI& operator=(const CompanyManagerUI&) = delete;
  CompanyManagerUI& operator=(CompanyManagerUI&&) noexcept = default;
  ~CompanyManagerUI() noexcept;
