...
namespace xml {
	...
	public:
		ConcreteBuilder& SetAllocator(allocator_holder alloc) {
			...
			return get_context<ConcreteBuilder>();				//ѕоскольку get_context<ConcreteBuilder>() - protected, обратитьс€ к ней смогут только наследники BuilderBase
		}
